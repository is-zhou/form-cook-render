const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Size.D6A-bmGV.js","assets/chunks/framework.Cu7FsKFC.js","assets/chunks/Label.D4XoUZNe.js","assets/chunks/FormRules.Djv2DwzF.js","assets/chunks/InlineForm.CeCImUlW.js","assets/chunks/DefaultBtn.BfdVljgI.js"])))=>i.map(i=>d[i]);
import{D as h,v as r,aX as k,p as v,C as A,c as b,o as D,aY as l,ag as o,G as a,ah as d,k as i,w as e,ax as c}from"./chunks/framework.Cu7FsKFC.js";import{L as m,N as y}from"./chunks/index.ZrIwg8oB.js";const _=`<script setup lang="ts">
import { ref } from "vue";
...
`,q=JSON.parse('{"title":"表单域配置 FormAreaConfig","description":"","frontmatter":{},"headers":[],"relativePath":"guide/basics/form-area.md","filePath":"guide/basics/form-area.md"}'),T={name:"guide/basics/form-area.md"},x=Object.assign(T,{setup(S){const u=h();r(async()=>{u.value=(await k(async()=>{const{default:t}=await import("./chunks/Size.D6A-bmGV.js");return{default:t}},__vite__mapDeps([0,1]))).default});const g=h();r(async()=>{g.value=(await k(async()=>{const{default:t}=await import("./chunks/Label.D4XoUZNe.js");return{default:t}},__vite__mapDeps([2,1]))).default});const E=h();r(async()=>{E.value=(await k(async()=>{const{default:t}=await import("./chunks/FormRules.Djv2DwzF.js");return{default:t}},__vite__mapDeps([3,1]))).default});const f=h();r(async()=>{f.value=(await k(async()=>{const{default:t}=await import("./chunks/InlineForm.CeCImUlW.js");return{default:t}},__vite__mapDeps([4,1]))).default});const n=v(!0),F=h();return r(async()=>{F.value=(await k(async()=>{const{default:t}=await import("./chunks/DefaultBtn.BfdVljgI.js");return{default:t}},__vite__mapDeps([5,1]))).default}),(t,s)=>{const p=A("ClientOnly");return D(),b("div",null,[s[5]||(s[5]=l(`<h1 id="表单域配置-formareaconfig" tabindex="-1">表单域配置 FormAreaConfig <a class="header-anchor" href="#表单域配置-formareaconfig" aria-label="Permalink to &quot;表单域配置 FormAreaConfig&quot;">​</a></h1><h2 id="默认按钮" tabindex="-1">默认按钮 <a class="header-anchor" href="#默认按钮" aria-label="Permalink to &quot;默认按钮&quot;">​</a></h2><ul><li>显示默认创建、重置按钮<code>defaultCreateBtn</code> <code>defaultRestBtn</code></li></ul><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">interface</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> FormAreaConfig</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
