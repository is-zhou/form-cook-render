const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Visible.3CUeBz8_.js","assets/chunks/framework.Cd6hzTNw.js","assets/chunks/DefaultValue.CFVeO6wh.js"])))=>i.map(i=>d[i]);
import{D as r,v as h,aX as d,p as g,C as b,c as v,o as E,aW as k,ag as m,G as a,ah as c,k as s,w as i,ax as u}from"./chunks/framework.Cd6hzTNw.js";import{L as f,N as y}from"./chunks/index.BpdcUPsw.js";const F=`<script setup lang="ts">
import { ref } from "vue";
...
`,Z=JSON.parse('{"title":"表单节点配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/basics/form-node.md","filePath":"guide/basics/form-node.md"}'),_={name:"guide/basics/form-node.md"},V=Object.assign(_,{setup(C){const l=r();h(async()=>{l.value=(await d(async()=>{const{default:t}=await import("./chunks/Visible.3CUeBz8_.js");return{default:t}},__vite__mapDeps([0,1]))).default});const e=g(!0),o=r();return h(async()=>{o.value=(await d(async()=>{const{default:t}=await import("./chunks/DefaultValue.CFVeO6wh.js");return{default:t}},__vite__mapDeps([2,1]))).default}),(t,n)=>{const p=b("ClientOnly");return E(),v("div",null,[n[2]||(n[2]=k(`<h1 id="表单节点配置" tabindex="-1">表单节点配置 <a class="header-anchor" href="#表单节点配置" aria-label="Permalink to &quot;表单节点配置&quot;">​</a></h1><h2 id="默认值" tabindex="-1">默认值 <a class="header-anchor" href="#默认值" aria-label="Permalink to &quot;默认值&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">interface</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> FormCompConfig</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> extends</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> BaseConfig</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
